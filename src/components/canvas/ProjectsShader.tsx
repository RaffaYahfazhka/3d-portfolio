...
const ProjectsShader: React.FC = () => {
  ...
  const images = [
    {
      ...
      src: './icons/ap.png',
      url: 'https://actionpay.id/id/',
    },

    {
      title: 'ClickCare',
      position: [0.1, -2 + posY, -0.09],
      src: './icons/clickcare-logo.png',
      url: 'https://clickcare.id',
    },

    {
      title: 'Mahesa Creative',
      position: [-0.1, -3 + posY, -0.09],
      src: './icons/mahesa-logo.png',
      url: 'https://mahesacreative.com/',
    },
  ...
  return (
    <>
      ...
      <ScrollControls
        pages={images.length + 1.5} // misalnya: 2 item = 3.5 page, 4 item = 5.5 page
        distance={1}
        damping={4}
        horizontal={false}
        infinite={false}
